...
namespace _Eindresultaat
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] monsterNames           = {"Murk", "Jerk", "Lurk", "Dirk"};
            ...
            while (isGameRunning)
            {
                ...
                if (gameOver == false)
                {
                    ...
                    if (playerWins < playerWinsEnd)
                    {
                        ...
                        for (var i = 0; i < graphicGoblin.Length; i++)
                        {
                            Console.Write(graphicGoblin[i]);
                            Console.Write("\n"); // new line
                        }
                    }
                    else
                    {
                        ...
                        for (var i = 0; i < graphicDemon.Length; i++)
                        {
                            Console.Write(graphicDemon[i]);
                            Console.Write("\n"); // new line
                        }
                    }
                    ...
                    // ALWAYS SHOW THE PLAYER HOW TO EXIT THE GAME:
                    Console.CursorTop += 1;
                    Console.ForegroundColor = ConsoleColor.DarkYellow;
                    Console.WriteLine("(To exit game, type \"" + commandQuit + "\".)");
                    ...
                    if (monsterHealth <= 0 || playerHealth <= 0 || playerRunAway)
                    {
                        Console.WriteLine("--- PRESS ANY KEY TO CONTINUE ---");
                        Console.CursorVisible = false;
                        Console.ReadKey(true);
                        ...
                        else if (playerRunAway)
                        {
                            // PUT THE PLAYER BACK X STEPS (VICTORIES):
                            playerWins -= playerRunSetback;
                            if (playerWins <= 0)
                            { playerWins = 0; }
                        ...
                        message = ""; // Clear the message before continuing. See next line:
                        continue; // Skips the rest of the code and starts at the top of the loop again.
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        // VICTORY END SCREEN:
                        Console.WriteLine("Good job, mate! ;D");
                    }
                    else
                    {
                        // GAME OVER SCREEN:
