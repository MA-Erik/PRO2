    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (playerWins < playerWinsEnd)
            {
                ...
                // L4 - Show the graphic:
                Console.WriteLine(graphicGoblin[0]);
                Console.WriteLine(graphicGoblin[1]);
                Console.WriteLine(graphicGoblin[2]);
                Console.WriteLine(graphicGoblin[3]);
                Console.WriteLine(graphicGoblin[4]);
                Console.WriteLine(graphicGoblin[5]);
            }
            else
            {
                // BOSS BATTLE:
